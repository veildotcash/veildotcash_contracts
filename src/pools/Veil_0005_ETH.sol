...
contract Veil_0005_ETH is MerkleTreeWithHistory, ReentrancyGuard {
    /// @dev The SNARK verifier contract used to verify zero-knowledge proofs
    Verifier public immutable verifier;
    /// @dev The fixed amount of ETH that can be deposited/withdrawn (0.005 ETH)
    uint256 public denomination = 0.005 ether;
